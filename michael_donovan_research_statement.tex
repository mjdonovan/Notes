...
My research has so far focused on the unstable Adams spectral sequence for simplicial commutative algebras. The \emph{stable} Adams spectral sequence for topological spaces  was introduced by Adams in 1958 \cite{MR0096219}, and its unstable counterpart was introduced by Bousfield and Kan in 1972 \cite{BousKanSSeq.pdf,BK_pairings.pdf}. On the other hand, the unstable Adams spectral sequence for simplicial commutative algebras was constructed by Radulescu-Banu only in 2006 \cite{radelescuBanu.pdf} (see also \cite{BlumRiehlResolutions.pdf}). Deeper study of the  classical case has since been performed by numerous authors, noting in particular Bousfield and Kan's construction  \cite{BK_pairings_products.pdf} of a Whitehead product on the classical unstable Adams spectral sequence. The unstable Adams spectral sequence was also generalised to other cohomology theories by Bendersky, Curtis and Miller in \cite{BendCurtisMiller.pdf}. Such study of the simplicial algebras case had not been performed, and has been a focus of my research.

Motivated and inspired by this and other work, I have taken on the task of performing all of this research for the Adams spectral sequence for simplicial algebras. 
...
For a definition of the notion of spectral sequence, see the beginning of section \ref{backgroundSection}. I prove the following two convergence theorems, which show that the spectral sequence does indeed calculate as desired. Firstly, a completeness theorem, originally conjectured by Radulescu-Banu \cite[Conjecture 6.1]{radelescuBanu.pdf}, and the analogue of the classical fact that simply-connected spaces are $\Z$-complete:
\begin{theorem}
...
\section{Background: the classical Adams spectral sequence}\label{backgroundSection}
