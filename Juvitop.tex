...
The injective and projective structures aren't right \rednote{(for what?)}. To demonstrate this, I'll try to characterise the (acyclic?) cofibrations on the model category $s\calC$ given the projective model structure.
\[\xymatrix{
