...
\includeversion{JandrGammaPractice}
...
Given vector spaces, I can embed them in a homotopy theory (cahin complexes) and then instead take homotopy orbits, so I might take, for $X$ a space:
