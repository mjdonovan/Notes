% !TEX root = z_output/KanSeminar.tex
...
\excludeversion{Kervaire NoDifferentiableStructure}
\excludeversion{AtiyahSegalEqKthy}
\excludeversion{AdamsStableHtpy}
\excludeversion{Quillen SpectrumOfEqCohomology}
\excludeversion{SegalCategories AndCohomologyTheories}
...
% Others' talks
\excludeversion{Jandr SSS notes}
...
\excludeversion{Jandr GammaCat notes}
...
\excludeversion{Jeremy RationalHomotopyPractice}
