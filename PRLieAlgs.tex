...
Define $\textup{DUB}_i(x):=\rho\Delta_{n-i}D^0(x\otimes x)+\rho\Delta_{n-i-1}D^0(x\otimes dx)$.
\begin{lem}
\[d(\textup{DUB}_i(x))+\textup{DUB}_i(dx)=\rho\Delta_{n-i+1}(1+\twist)D^0(x\otimes x)+\rho\Delta_{n-i}(1+\twist)D^0(dx\otimes x)\]
\end{lem}
\begin{proof}
In light of the fact that $D^0$ is a chain map,
\begin{alignat*}{2}
d(\textup{DUB}_i(x))
&=
...
\begin{lem}
For all $r$, positive or otherwise:
...
\[d(\textup{DEL}^\textup{alg}_i(x))+ \textup{DEL}^\textup{alg}_i(dx)=S_\textup{alg}^{t-i+1,s}(x)+d(\textup{DUB}_i(x))+\textup{DUB}_i(dx)\]
\end{cor}
\begin{proof}
\begin{alignat*}{2}
\textup{LHS}
...
\\
&\ \ \ \ \ \ \ \ \ +\bigl(\Delta\sigma D^{i-n-1}+\Delta_{n-i+1}(1+\twist)D^0+\sum_{\mathclap{\alpha-\beta=n-i+1}} \phi_{\alpha}\sigma^{\alpha-1}D^{\beta}\bigr)(x\otimes x)\Bigr\}+{}%
\\
&\ \ +\rho\Bigl\{(1+\twist)\mathbb{D}_{n-i}(dx\otimes x)+{}
\\
&\ \ \ \ \ \ \ \ \ +\bigl(\Delta\sigma D^{i-n}+\Delta_{n-i}(1+\twist)D^0+\sum_{\mathclap{\alpha-\beta=n-i}} \phi_{\alpha}\sigma^{\alpha-1}D^{\beta}\bigr)(dx\otimes x)\Bigr\}
\\
&=
