...
The first claim is \ref{towerIsHomotopical}. Apply $(D^t\DASH)X$ to the diagram of functors to constructed in \ref{towerWithPowers}, to obtain the following diagram in $s\Comm$:
\[\xymatrix@R=4mm{
\cdots 
\ar[r]
&%r1c1
