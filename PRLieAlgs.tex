...
\subsection{Bousfield-Kan $D^1$-construction blurb}
It seems that to use the construction of Bousfield-Kan \cite{BK_pairings_products.pdf,BK_pairings.pdf}, we'll need to understand the construction of $D^1X$, for cosimplicial objects $X$:
\[\xymatrix@R=4mm{
D^1X\ar[r]
\ar[d]^-{\delta}
...
This diagram constructs both a map $X^\fraks\otimes X^\fraks\to\overline{D}^1X$ and a zig-zag of weak equivalences from $\overline{D}^1X$ to $D^1X$. This also shows that the small square in the to right corner of the diagram of interest commutes.
...
Although some arrows are decorated for emphasis, all of the arrows in this diagram have already been defined [although I haven't given $A$ a name]. The composite of the dotted maps equals the composite of the wavy maps
