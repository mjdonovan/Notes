...
\ar[r]^-{[\frakd_{iq}]^{s+t}\trip{d}{iq}{X}}_-{[\frakd_{iq}]^{s-1}[\frakd_{q+i,2q}\circ\frakd_{i,2q+1}][\frakd_{iq}]^{t-1}\trip{d}{iq}{X}}
&
K_{q-1}\\
\makebox[0cm][r]{$\trip{s}{iq}{K}:\,$}K_q
\ar[r]^-{[\fraks_{iq}]^{s+t}\trip{s}{iq}{X}}_-{[\fraks_{iq}]^{s-1}[\fraks_{q+i+1,2q+2}\circ\fraks_{i,2q+1}][\fraks_{iq}]^{t-1}\trip{s}{iq}{X}}
&
K_{q+1}\\
...
\ar[r]_-{([\fraks_{jq}]^{s-1}T^{j+1}\rho^{q}T^{q-j+1}[\fraks_{jq}]^{t-1}\trip{s}{jq}{X})}^-{[\fraks_{jq}]^{s-1}[\frakd_{j+1,2q+1}\circ\cdots \circ\frakd_{j+1,q+2}][\fraks_{jq}]^{t-1}\trip{s}{jq}{X}}
&
L_{q+1}\\
}\]
