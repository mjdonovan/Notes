...
We're interested in derived abelianization of partially restricted Lie algebras. For a PR Lie algebra $L$, write $L^r$ ($L^u$) for the linear subspace of (un)restrictable elements. Write $UL$ for the PR universal enveloping algebra of $L$ --- this is the initial associative algebra with a PRL map from $L$. To make sense of partial restrictions, recall that restrictability is always defined by nonvanishing of certain gradings.
