...
\subsection{A chain level fold map, etc.}
...
\end{lem}
\begin{proof}
This follows since $(\textup{id}\sqcup0)\psi_1$ is the identity of $S^n$ and $(\textup{id}\sqcup0)\psi_2$ is the identity of $CS^n$.
\end{proof}
...
&%r2c1
\pi((QW^{n+1}X)^{\otimes2})\ar[u]^-{\textup{AW}_{\textup{in}}}
&%r2c2
&%r2c3
&%r2c4
&%r2c5
&%r2c6
&%r2c7
(Q\pi(W^{n+1}X))^{\otimes2}\ar[u]_-{\gamma^{\otimes2}}\\%r2c8
&%r3c1
\pi Q((W^{n+1}X)^{\wedge 2})\ar[u]^-{\pi(j)}
\ar[dl]
&%r3c2
&%r3c3
&%r3c4
...
&%r3c1
\pi Q(W^{n+2}X)
\ar@/_.5em/[uu]_-(.25){\pi Q(\xi_{\textup{ch}})}
\ar[ul]^-(.65){\pi Q(\overline{\xi}_{\textup{ch}})}
&%r3c2
&%r3c3
&%r3c4
Q\pi(W^{n+2}X)\ar[lll]_-{\gamma}
\ar@/_.5em/[uu]_-(.25){Q\pi(\xi_{\textup{ch}})}
\ar[ul]^-(.65){Q\pi(\overline{\xi}_{\textup{ch}})}
&%r3c5
&%r3c6
&%r3c7
Q(\pi( W^{n+2}X))
\ar@/_.5em/[uu]_-(.25){Q(\xi_{\LL{}})}
\ar[lll]_-{=}
\ar[ul]^-(.65){Q(\overline{\xi}_{\LL{}})}
}\]
