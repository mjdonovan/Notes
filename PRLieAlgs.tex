...
\ar[r]^-{\textup{sEZ}}
&%r1c1
\pi_{\frakt}(X^\fraks\wedge  X^\fraks)\ar[r]
&%r1c2
\pi_{\frakt}(\overline{D}^1X^\fraks)&%r1c3
...
\ar@{..>}[ddddr]^-(.2){F}
&%r1c1
\pi_{\frakt}(X^\fraks\wedge  X^\fraks)\ar[r]^-{\overline{\mu}_*}
&%r1c2
\pi_{\frakt}(\overline{D}^1X^\fraks)&%r1c3
...
equals $\widetilde{(\epsilon\alpha)}\sqcup \widetilde{(\epsilon\beta)}$.
\end{lem}
\begin{proof}It's enough to show that the following commutes:
%Using naturality of $\overline{F}$ and the fact that $h=c(\textup{add}\circ(\epsilon\times\epsilon))$:
\[\xymatrix@R=4mm{
S^t\sqcup S^{t'}\ar@{ >->}[d]
%\ar[rrd]_-{\widetilde{(\epsilon\alpha,0)}\sqcup \widetilde{(0,\epsilon\beta)}}
...
\begin{proof}
We must show that $\partial_\textup{conn}(\textup{dot}(\alpha,\beta))=\overline{\mu}_*(\textup{sEZ}(\alpha,\beta))$.
All of the previous discussion together has shown $\textup{dot}(\alpha,\beta)$ is the image in $Q\overline{V}X^\fraks=\overline{V}X\fraks$ of the cycle $g\in Qc_{t,t'}$ under the top row of the following commuting diagram:
\[\xymatrix@R=4mm@C=10mm{
\makebox[0cm][r]{$g\in\,$}QC_{t,t'}\ar[r]^-{Q\overline{F}(\alpha,\beta)}
&%r1c2
Qc(X^\fraks)^2\ar[r]^-{Qc(\textup{add}\circ\epsilon^2)}
&%r1c3
QX^\fraks\ar[r]^-{Q\overline{v}}
&%r1c4
...
\ar[d]_-{d_0}
&%r1c2
c(X^\fraks)^2\ar[r]^-{c(\textup{add}\circ\epsilon^2)}
\ar@{->>}[u]
\ar[d]_-{d_0}
&%r1c3
X^\fraks\ar@{->>}[r]^-{\overline{v}}
\ar@{->>}[u]
\ar[d]^-{d_0}
&%r1c4
...
%\[0\to\overline{D}^1X^\fraks\to X^\fraks\overset{\overline{v}}{\to} \overline{V}X^\fraks\to 0,\]
 This confirmins that $\partial_\textup{conn}(\textup{dot}(\alpha,\beta))$ is the image under $\alpha\sqcup\beta$ of $\textup{EZ}^\mu(\imath_t,\imath_t')$, completing the proof.
\end{proof}
