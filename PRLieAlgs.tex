...
\end{alignat*}
\subsection{The effect of applying $\SqShift^0$}
\[t_N-s_N=
2(t_{N-1}-s_{N-1})+\ell^{N-1}\]
\subsection{The effect of adding a bar, `$\SqShift^k$'}
\[t_{N_0+1}-s_{N_0+1}=
2(t_{N_0}-s_{N_0})+\ell^{N_0}-k\]
Thus, the bonus is $B_0=\ell^{N_0}-k$.

\subsection{The effect of appending `$\SqShift^j$'}
\begin{alignat*}{2}
t_{N_1}'
&=
2(t_{N_1}+1)-1%
...
\subsection{$(\textup{add},\textup{app})$-propagation}
...
\subsection{$(\textup{add},\textup{add})$-propagation}
The relation $B_1-B_0=1$ becomes
\[\ell^{N_1}-k_1-(\ell^{N_0}-k_0)=1\]
\[k_1=k_0+\ell^{N_1}-\ell^{N_0}-1\]

\subsection{$(\textup{app},\textup{add})$-propagation}
The relation $B_1-B_0=1$ becomes
...
\subsection{$(\textup{app},\textup{app})$-propagation}
The relation $B_1-B_0=1$ becomes
...
For example, [[1,0],[1,0],[1,1,0]]$\to$[[1,2,0],[1,1,1,0]] came from 
[[0],[1,0],[1,1,0]]$\to$[[2,0],[1,1,1,0]]
