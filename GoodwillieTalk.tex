...
\tallstrut \uncover<2->{Can demand: $|a_{(f\scrx)}|\leq L\cdot|u|\cdot|v|\cdot|w|$ for all short $u,v,w$.}\\ %$\partial_w\partial_v\partial_uf(x_{\emptyset })$\\
\vspace{.5cm}
\begin{tikzpicture}[scale=1.2]
\path (0.3,0) node[name=2] {$\bullet $};
\path (1.3,0) node[name=12] {$\bullet $};
...
\path (4.5,2.5) node[shape=rectangle] {\underline{$f\scrx$}};
\end{tikzpicture}\\
\tallstrut \uncover<1->{Then $|\partial_w\partial_v\partial_uf|\leq L$ (where it exists) whenever $|u|,|v|,|w|\leq1$.}
...
&%r1c1
\overset{\makebox[0cm][c]{\scriptsize$E_n(c-3,\kappa-3)$}}{T_n^3F\makebox[0cm][l]{\ \ $\cdots$}}
...
\ar[r]
&%r1c1
T^2_nF (\scrX_\emptyset )
\ar[d]^-{a_{T_nF(\scrX)}}\ar[r]
&%r1c2
T^3_nF (\scrX_\emptyset) 
\ar[d]^-{a_{T_n^2F(\scrX)}}\ar@{..>}[rr]
&%r1c3
%\cdots\ar[r]
&%r1c4
P_nF(\scrX_\emptyset )\ar[d]^-{a_{P_nF(\scrX)}}
\\%r1c5
h_0(F(\scrX))\ar[r]
&%r2c1
h_0(T_nF(\scrX))\ar[r]
&%r2c2
h_0(T^2_nF(\scrX))\ar@{..>}[rr]
&%r2c3
%\cdots\ar[r]
&%r2c4
h_0(P_nF(\scrX))%r2c5
