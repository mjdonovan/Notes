...
Any given entry is likely to be incorrect; nothing found in this document should
be relied upon. Anybody unfortunate enough to be reading this, upon finding an
error, should let me know. If you are the person who told me something in here,
and want your name at the end let me know. I'm not doing this for now, since
stuff in here is likely to be incorrectly transcribed, and nobody wants their
name on something that's wrong.

\HSsection{\texorpdfstring{$H_*(X)=\pi_*(\textup{Sp}^\infty X)$ when $X$}{HX=pi(SpX) when X} is connected}{29/6/11}
...
\HSsection{\texorpdfstring{$Q$}{Q} turns cofiber sequences into fiber sequences}{29/6/11}
