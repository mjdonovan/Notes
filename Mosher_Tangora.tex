...
\MyRuLe\raisebox{-.5mm}{\MyRuLe} k\MyVRuLe{\ \ }
			& X_0 				&\KWhatWhat{\Z_2}{n\Splus1}&X_1				&\KWhatWhat{\Z_2}{n\Splus2}&X_2 				&\KWhatWhat{\Z_8}{n\Splus3}&X_3 			&\KWhatWhat{\Z_2}{n\Splus6}&X_4 			&K(\Z_{16},n\Splus6)\\%\KWhatWhat{\Z_{16}}{n\Splus6}\\
...
4         		&4					&3					&\Squ^4\imath_n			&2\ar[ldd]				&\Squ^4\imath_n			&d_3\ar[ldd]&					&\\
...
8         		&8					&421 \ar[ldddd]\ar[lddddd]&\Squ^8\imath_n			&					&\Squ^8\imath_n			&					&\Squ^8\imath_n			&&\Squ^8\imath_n&d_4\ar[ldddd]\\
