...
This gives a cochain complex which is natural in $\scrA$, whose homology defines
...
\[0\to\varprojlim\scrA\to\varprojlim\scrB\to\varprojlim\scrC\to\varprojlim^1
\scrA\to\varprojlim^1\scrB\to\cdots;\]
and a flabby inverse system is acyclic.
\end{prop}
...
to which we apply $\varprojlim$, drop the first column, and take homology. But
