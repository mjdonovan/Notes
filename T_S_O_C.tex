...
\fi
%%% This functionality probably now broken

%%%%%% ERRATA

%p182: In second compatibility, $E_i$ should be $E_{i+j-1}$.

%II5.17: Does any spectrum of finite type actually have finite $\Z$-type? Does the spectrum not also need to be bounded below?
