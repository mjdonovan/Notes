...
Given a cohomology theory $h^*$ on $\Specf$, we can form a homology theory
thereupon via $h_i(X):=h^{-i}(X^\perp)$. (The minus sign appears so that the
suspension isomorphisms in $h_*$ are as required. This is well defined as dual
spectra are unique, and exist by 2.4 and 2.9.)
\end{condef}
\end{document}
