...
\begin{ToFollow}
A lot of material I don't know well on the Steenrod algebra, and generalities on all the topics listed.
\end{ToFollow}
...
\end{defn}
\begin{ToFollow}
A couple of examples of this construction --- a completed graded tensor product (of two graded abelian groups), and the profinitely completed tensor product $E^*(X)\hat\otimes F^*(Y)$.
\end{ToFollow}
}   %%% End comment %%%
...
Now there are two spectral sequences both converging to the cohomology to the
cohomology of the total complex. In the spectral sequence in which $d_1$ takes
cohomology along each row, the $E_2$ page consists of the cohomology of $\scrA$
lined up along the bottom row. The $E_2$ page of the other spectral sequence
consists of the cohomology of the first column, all else having vanished.
\end{proof}
