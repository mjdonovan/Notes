%  
%  Please don't add to me any more. Only use me if
%  you need to for an old application. If tempted 
%  to add to me, try switch to macros in dropbox, via:
%  \input{../../Dropbox/logbook/_LOGBOOK/macros.tex}
%  

\ifx\BEAMERMODE\undefined
\relax
\else
\providecommand{\dontloadtocloft}{}
\fi
%%%To use beamermode, the first four lines should be:
