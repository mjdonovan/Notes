...
\begin{shaded}
Should understand the last requirement.
\end{shaded}
\end{itemize}
...
Let $\Ring$ be the category of commutative unital rings. Let $\FGL:\Ring\to\Set$ be the functor sending a ring to the set of FGLs over $R$. Let $\SI:\Ring\to\Set$ be the functor sending a ring to the set of triples $(F,f,G)$ where $R,G\in\FGL(R)$ and $f:F\to G$ is a strict isomorphism.
