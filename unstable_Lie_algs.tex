...
\includeversion{Cohomology operations for unstable Lie algebras over Lambda}
...
\textbf{Koszul operations:}
Next, we must identify the operations $\Sq_\textup{v}^i$ defined using $\psi_{\BSW}$ with the operations $\Sq_v^i$ defined in \S\ref{section: vertical Koszul operations n positive} using the map $\gamma_i$.
\end{proof}
