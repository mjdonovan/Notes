...
&%r3c3
&%r3c4
Q\pi((W^{p+k}L)^{\wedge 2})\ar[lll]_-{\gamma}
&%r3c5
&%r3c6
&%r3c7
Q((\pi( W^{p+k}L))^{\wedge 2})
\ar[uu]_-{j}
\ar[lll]_-{Q(i)}
\\\\
&%r3c1
...
The bottom left square commutes simply by naturality of $\gamma$, while the bottom right square is an instance of lemma \ref{LemmaOn xi}. What remains is to check that the hexagon commutes.
\end{proof}
