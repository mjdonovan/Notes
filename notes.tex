...
\end{itemise}
\myheading{\texorpdfstring{$\Q$ and $\C$ are flat $\Z$-modules}{Q and C are flat Z-modules}}
...
$\C$ over $\Q$. As $\C$ is a free $\Q$-module, it is flat over $\Q$. As $A\otimes_{\Z}\C=A\otimes_{\Z}\Q\otimes_{\Q}\C$, $\C$
is flat over $\Z$.
