...
\excludeversion{TOContents}
\includeversion{Births Deaths and Marriages}
\includeversion{discussion of EHP SS}
\excludeversion{discussion with jandr}
\excludeversion{SS of a Filtered Complex}
\excludeversion{Leray Serre Hirzebruch SS}
\excludeversion{clutching v classifying}
\excludeversion{projective bundle theorem}
\excludeversion{applications of steenrod squares}
\excludeversion{A-adams resolutions}
\excludeversion{abelian categories}
\excludeversion{Q and C are flat}
\excludeversion{Cohomology is representable}
\excludeversion{Cofinal functors}
\excludeversion{Acyclic Kan fibrations}
