...
\includeversion{4. Basic concepts in enriched category theory}
\excludeversion{5. The unreasonably effective (co)bar construction}
\excludeversion{6. Homotopy limits and colimits, the theory}
\includeversion{7. Homotopy limits and colimits, the practice}
