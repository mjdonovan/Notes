...
\end{cases}$
\end{enumerate}
The $\delta$-operation with $i\leq t-s$ at $\delta_i:E^\infty_{-s,t}\to E^\infty_{-s-1,t+i+1}$, for $i\leq t-s$, agrees with the homotopy operations $\delta_i:\pi_{t-s}\to \pi_{t-s+i}$ on the target of the spectral sequence, and similarly for the product at $E^\infty$.
