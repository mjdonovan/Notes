% !TEX root = z_output/ProbMeth.tex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%% 80 characters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\excludeversion{chapter4}
\excludeversion{chapter5}
\excludeversion{chapter6}
\excludeversion{chapter7}
\includeversion{recent}
...
\begin{proof}
Let $\calC$ be the obvious large chain: $\calC:=\{\{1\},\{1,2\},\ldots,\{1,\ldots,n\}\}$. Choose a random permutation $\sigma\in\Sigma_n$. Then for $A\in\calF$:%\calP(\{1,\ldots,n\})$:
...
\begin{alignat*}{2}
|P_n(x)-f(x)|&\leq\sum_{i=0}^{n}\rho(i)|f(i/n)-f(x)|%&\qquad&\text{()}
\\&=\sum_{|i-nx|\leq n^{2/3}}\rho(i)|f(i/n)-f(x)|+\sum_{|i-nx|\geq n^{2/3}}\textup{same}%&\qquad&\text{()}
\\&\leq\sum_{|i/n-x|\leq n^{-1/3}}\textup{same}+2\max\{|f(x)|\}\Prob[|B(n,x)-nx|>n^{2/3}]%&\qquad&\text{()}
\\&\leq1\times\max_{|i/n-x|\leq n^{-1/3}}|f(i/n)-f(x)|+2\max\{|f(x)|\}\cdot n^{-1/3}%&\qquad&\text{()}
\end{alignat*}
