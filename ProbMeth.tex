...
Let $A_1,\ldots,A_n$ be events. Suppose that each is mutally independent of a set of all but $d$ others, and $\Prob[A_i]\leq p$. Then if $ep(d+1)\leq 1$, there is a nonzero probability that none of the \smash{$A_i$} occurs.
\begin{proof}
